...
def image_detail(request, id, slug):
    ...
    #Увеличить кол-во просмотров изобржений на 1
...
def image_list(request):
    ...
    try:
        ...
        if images_only:
            ...
            return HttpResponse('')
        #Если страница вне диапозона, то вернуть посл страницу результатов
...
def images_ranking(request):
    ...
    return render(request, 'images/image/rating.html',
                {'section': 'images',
